      ...
      <ScrollView>
        <View>
          ...
          <View style={{ marginTop: 20, alignSelf: "center" }}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <TouchableOpacity style={AuthStyle.shortButton}
                                onPress={() => toggleModal()}>
                <Text style={AuthStyle.buttonText}>중복 확인</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={{ marginTop: 20, alignSelf: "center" }}>
          ...
          <View style={{
            ...
            <Text style={{ marginLeft: 10, fontFamily: "tway_air", fontSize: 13 }}>개인 정보 처리 방침</Text>
          </View>
          <View style={{ alignSelf: "center" }}>
            <View style={{
              ...
              <ScrollView>
                <Text>{`
아이신선해는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.

1. 개인정보의 수집 및 이용 목적, 수집하는 개인정보의 항목 및 수집방법

아이신선해는 다음과 같은 개인정보를 수집하고 있습니다.

1. 필수항목: 로그인을 위한 정보. (이메일 주소 및 비밀번호 또는 Naver ID, Kakao ID 등 가입을 위해 연결된 서비스 계정)
3. 수집방법: 어플리케이션
4. 서비스 이용과정이에서 서비스 이용기록, 접속 로그, 접속 IP정보, 기기정보 기록과 같은 정보들이 생성되어 수집 가능

2. 개인정보의 처리 및 보유 기간

1. 아이신선해는 동의 받은 개인정보를 회원의 이용기간 내에서 처리,보유합니다.
2. 회원의 탈퇴시엔 지체없이 개인정보를 삭제하나, 관련 법령에서 의무보유기간에 대해 별도로 정한 경우에는 해당 기간 종료 시까지 개인정보를 보유합니다.

3. 정보주체와 법정대리인의 권리·의무 및 그 행사방법

이용자는 개인정보 주체로서 다음과 같은 권리를 행사할 수 있습니다.

1. 회원 및 법정대리인(회원이 만 14세 미만 아동인 경우)은 법령에 저촉되지 아니하는 범위 내에서 자신 또는 만 14세 미만 아동의 개인정보에 대한 열람, 정정, 삭제, 처리정지를 요청할 수 있습니다. 회사는 법령이 정한 바에 따라 본인확인 기타 사실확인을 위한 정보 또는 자료의 제공을 요청할 수 있습니다.
2. 제1항에 따른 권리 행사는 아이신선해에 대해 개인정보 보호법 시행령 제41조제1항에 따라 전자우편 등을 통하여 하실 수 있으며 아이신선해는 이에 대해 지체 없이 조치하겠습니다.
...
6. 아이신선해는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.

5. 개인정보의 파기

1. 회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 해당 개인정보를 복구·재생할 수 없도록 지체 없이 파기합니다.
2. 전항에도 불구하고 이용자로부터 계속 보관·이용에 관한 별도 동의를 받거나 관련 법령에 따라 개인정보를 계속 보유하여야 하는 경우에는, 해당 개인정보를 해당 목적 범위 내에서 안전하게 보관·이용합니다.
...
1. 회원의 개인정보는 비밀번호에 의해 철저히 보호되고 있으며 본인이 제공한 이메일주소에 매칭되는 비밀번호는 본인만이 알고 있습니다. 따라서 개인정보의 확인 및 변경도 비밀번호를 알고 있는 본인에 의해서만 가능합니다.
2. "회사"의 개인정보 보호를 위한 기술적/관리적 대책은 다음과 같습니다.
    1. 관리적 조치 : 내부관리계획 수립 및 시행, 정기적 직원 교육 등
    2. 기술적 조치 : 개인정보처리시스템 등의 접근권한 관리, 접근통제시스템 설치, 고유식별정보 등의 암호화, 보안프로그램 설치
    3. 물리적 조치 : 전산실, 자료보관실 등의 접근통제

7. 개인정보 관리 책임자의 성명, 연락처, 부서

이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 "회사"는 개인정보관리책임자를 두고 있습니다. 개인정보와 관련한 문의사항이 있으시면 아래의 개인정보관리책임자에게 연락 주시기 바랍니다.

- 이 름 : 정지원, 신혜원, 임주경
- 소 속: 아이신선해
- E-mail: jiwon936626@gmail.com
...
현재 개인정보 취급 방침에서 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항의 시행일의 7일 전부터 "회사" 사이트의 공지사항을 통하여 고지 할 것 입니다. 다만, 회원의 권리 또는 의무에 중요한 내용의 변경은 최소 30일전에 고지하겠습니다.아이신선해는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
              `}</Text>
              </ScrollView>
            </View>
          </View>
          <View style={{
            ...
            <Text style={{ marginLeft: 10, fontFamily: "tway_air", fontSize: 13 }}>서비스 이용 약관</Text>
          </View>
          <View style={{ alignSelf: "center" }}>
            <View style={{
              borderWidth: 1,
...
제1조 (목적) 이 약관은 아이신선해(이하 “회사”라 합니다)가 모바일 기기를 통해 제공하는 어플리케이션 서비스 및 이에 부수하는 네트워크, 웹사이트, 기타 서비스(이하 “서비스”라 합니다)의 이용에 대한 회사와 서비스 이용자의 권리ㆍ의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
제27조 (재판권 및 준거법) 이 약관은 대한민국 법률에 따라 규율되고 해석됩니다. 회사와 회원 간에 발생한 분쟁으로 소송이 제기되는 경우에는 법령에 정한 절차에 따른 법원을 관할 법원으로 합니다.
